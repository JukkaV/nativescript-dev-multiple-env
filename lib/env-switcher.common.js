...
class EnvSwitcherCommon {
    ...
    copyFiles(inputFolder) {
        ...
        // new RegExp(this.currentEnvironment.copyRules);
        ...
        this.logger.info('Using copyRules:', matchesRules);
            ...
            try {
                ...
                if (stat.isDirectory()) {
                    ...
                    matchesRules.forEach(matchesRule => {
                        const matchesRuleRegExp = new RegExp(matchesRule);
                        ...
                        if (matchesRuleRegExp.test(file)) {
                            ...
                            this.logger.info('Renaming file ' + file + ' to ' + newFileName + ' in dir ' + inputFolder);
